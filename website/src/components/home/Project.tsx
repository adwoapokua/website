...
function Project() {
  ...
  return (
    <section id="projects" className="min-h-screen flex flex-col gap-8 px-8 mb-30 lg:px-20 scroll-mt-24">
                        ...
                        <div className="flex gap-1.5">
                            {
                                project.tools.map((tool) => (
                                    <div className="rounded-2xl lg:text-xs lg:px-3 lg:py-1 px-4 py-2 whitespace-nowrap text-center bg-accent/50 text-primary">{tool}</div>
                                ))
                            }
                        </div>
                        <div className="text-xl lg:text-lg font-bold">{project.name}</div>
                        <div className="lg:text-sm">{project.description}</div>
