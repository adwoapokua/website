...
function Contact() {
  ...
  return (
    <section id="contact" className="py-16 flex flex-col gap-10 mx-8 mb-30 lg:justify-center lg:items-center scroll-mt-24">
      <div className="text-secondary font-bold text-3xl lg:text-4xl">
        <p>Say Hi <span className="text-primary">&</span> tell me about your idea</p>
      </div>
      <form action="" className="flex flex-col gap-10 w-full lg:w-130">
      ...
      <div className="mt-10 w-full lg:w-130">
