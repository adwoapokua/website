...
function Contact() {
  ...
  return (
    <section id="contact" className="min-h-screen flex flex-col gap-10 px-8 mb-30 lg:justify-center lg:items-center scroll-mt-24">
      <div className="text-secondary font-bold text-4xl">
        <p>Say Hi <span className="text-primary">&</span> tell me about your idea</p>
      </div>
      <form action="" className="flex flex-col gap-10 lg:w-130">
